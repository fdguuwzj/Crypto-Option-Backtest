...
if __name__ == '__main__':
    ...
    backtrader = BackTrader(initial_capital=50000, strategy_params={'name': 'sell_straddle','exe_price_gear':4, 'mature_gear': 2} ,data=data, date_interval=['2024-11-01 00:00:00', '2024-11-18 00:00:00'], fraction=0.01, open_type='volume_ratio_abs', open_value=0.01, trading_logger=trading_logger)
